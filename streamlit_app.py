...
PLATFORM_TEMPLATES = {
    ...
    "meta":      "utm_source=dw_meta&utm_medium={type}_paid{objective}&utm_campaign={theme}_{aud}_{creative}&utm_content={{campaign.id}}{{adset.id}}{{ad.id}}_{{placement}}",
    "linkedin":  "utm_source=dw_linkedin&utm_medium={type}paid{objective}&utm_campaign={theme}_{aud}_{creative}&utm_content={{CAMPAIGN_GROUP_ID}}{{CAMPAIGN_ID}}{{CREATIVE_ID}}",
    ...
    # ── Programmatic ──
    "adsp":      "utm_source=dw_adsp&utm_medium={type}_paid{objective}&utm_campaign={theme}_{aud}_{creative}&utm_content={%campaign_cfid}{%ad_cfid}_{%creative_cfid}",
    "tradedesk": "utm_source=dw_tradedesk&utm_medium={type}paid{objective}&utm_campaign={theme}_{aud}_{creative}&utm_content=%%TTD_CAMPAIGNID%%%%TTD_ADGROUPID%%%%TTD_CREATIVEID%%%%TTD_PUBLISHER_NAME%%_%%TTD_SITE%%",
    # ── Social platforms ──
    "tiktok":    "utm_source=dw_tiktok&utm_medium={type}_paid&utm_campaign={theme}_{aud}_{creative}&utm_content=_CAMPAIGN_ID_AID_CID_",
    "reddit":    "utm_source=dw_reddit&utm_medium={type}_paid&utm_campaign={theme}_{aud}_{creative}&utm_content={{campaign.id}}{{adgroup.id}}{{ad.id}}",
    "quora":     "utm_source=dw_quora&utm_medium={type}_paid&utm_campaign={theme}_{aud}_{creative}&utm_content={{campaign.id}}{{adset.id}}_{{ad.id}}",
    "x":         "utm_source=dw_x&utm_medium={type}_paid&utm_campaign={theme}_{aud}_{creative}&utm_content={{tw_campaignid}}{{tw_adgroupid}}{{tw_adid}}",
    "snapchat":  "utm_source=dw_snapchat&utm_medium={type}_paid&utm_campaign={theme}_{aud}_{creative}&utm_content={{campaign.id}}{{adset.id}}{{ad.id}}",
}
